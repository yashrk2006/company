    ...
    <div className="min-h-fit relative overflow-x-hidden bg-[#050505] text-[#D4AF37] font-serif selection:bg-[#D4AF37] selection:text-black flex flex-col pt-0">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
         ...
         <motion.div 
           ...
           className="absolute bottom-[-10%] left-[-10%] w-[1000px] h-[1000px] bg-[radial-gradient(circle,#D4AF37_0%,transparent_70%)] blur-[180px] opacity-10"
         />
      ...
      <section className="relative z-10 min-h-fit flex flex-col items-center justify-center p-12 lg:p-48 text-center bg-transparent">
         ...
         >
            ...
            <h1 className="text-7xl md:text-[12rem] lg:text-[15rem] font-extralight tracking-[0.25em] uppercase leading-[0.8] mb-16 text-white text-shadow-xl">
              CURATED <br />
      ...
      <section className="relative z-10 py-48 px-8 md:px-24 bg-white/5 border-y border-[#D4AF37]/10 overflow-hidden">
         <div className="absolute top-[-20%] left-[-10%] w-[800px] h-[800px] border border-[#D4AF37]/5 rounded-full pointer-events-none" />
      ...
      <section className="relative z-10 py-48 px-12 md:px-32 bg-transparent overflow-hidden">
         <div className="max-w-screen-2xl mx-auto space-y-48">
            <div className="flex flex-col md:flex-row justify-between items-end gap-12 border-b border-[#D4AF37]/20 pb-16">
               <div className="space-y-6">
                  ...
                  <h2 className="text-7xl md:text-[10rem] font-extralight tracking-[0.3em] text-white uppercase leading-none italic">CURATION.</h2>
               </div>
      ...
      <section className="relative z-10 py-48 px-8 md:px-24 bg-white/5 border-y border-[#D4AF37]/10">
         <div className="max-w-7xl mx-auto flex flex-col items-center">
            <div className="text-center mb-48 space-y-12">
               ...
               <h2 className="text-7xl md:text-[14rem] font-extralight text-white tracking-[0.4em] uppercase leading-none">MEMBERSHIP.</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 w-full lg:max-w-6xl">
               {/* Tier 1 */}
               <div className="p-24 border border-[#D4AF37]/10 bg-black group relative overflow-hidden flex flex-col justify-between">
                  ...
                  <div className="space-y-20 relative z-10">
                     ...
                     <div className="space-y-4">
                        <div className="text-[10rem] font-light text-white tracking-tighter leading-none italic">$2,500<span className="text-xs opacity-20 tracking-[1em] ml-12 not-italic">/annum</span></div>
               ...
               {/* Tier 2 */}
               <div className="p-24 bg-[#D4AF37]/5 border-2 border-[#D4AF37]/40 relative group overflow-hidden shadow-[0_0_100px_rgba(212,175,55,0.1)] flex flex-col justify-between">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#D4AF37]/10 to-transparent pointer-events-none" />
                  <div className="absolute top-0 right-0 p-24 opacity-10 rotate-12 group-hover:rotate-0 transition-transform duration-1000">
                  ...
                  <div className="space-y-20 relative z-10">
                     ...
                     <div className="space-y-6 text-center">
                        <div className="text-[12rem] font-light text-white tracking-tighter leading-none italic">$9,800<span className="text-xs opacity-40 ml-16 not-italic uppercase tracking-[1.5em]">/eternity</span></div>
      ...
      <section className="bg-black py-48 px-12 md:px-32 relative overflow-hidden text-center z-10 border-t border-[#D4AF37]/10">
         ...
         >
            <div className="space-y-8">
               <h2 className="text-8xl md:text-[12rem] font-extralight text-white tracking-[0.2em] uppercase leading-tight italic">
            ...
            <div className="flex flex-col items-center gap-16">
               <motion.button 
                 ...
                 className="px-32 py-12 bg-transparent border-2 border-[#D4AF37] text-[#D4AF37] font-light uppercase tracking-[0.8em] text-3xl hover:bg-[#D4AF37] hover:text-black transition-all duration-1000 shadow-2xl"
               >
                  Inquire
               </motion.button>
               <div className="space-y-4">
      ...
      <footer className="p-12 md:p-48 bg-black border-t-8 border-black flex flex-col gap-48 relative z-10 overflow-hidden">
         ...
         <div className="flex flex-wrap justify-center gap-20 pt-48 border-t border-[#D4AF37]/10 w-full max-w-screen-2xl mx-auto relative z-10">
