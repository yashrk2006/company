...
const BrutalistMockup = ({ theme }) => {
  return (
    <div className="h-full bg-white flex flex-col font-heading selection:bg-black selection:text-[#FFD600]">
      ...
      <div className="border-b-4 border-black p-12 bg-[#FFD600] flex justify-between items-center relative overflow-hidden group">
         ...
         <div className="relative z-10">
            ...
            <h4 className="text-8xl font-black uppercase leading-[0.85] italic tracking-tighter text-black">
               RAW<br />POWER.
            </h4>
         </div>
      ...
      <div className="flex-grow grid grid-cols-1 md:grid-cols-3 divide-x-4 divide-y-4 md:divide-y-0 divide-black">
         {[
            ...
            <div key={i} className={`p-10 flex flex-col justify-between group transition-colors hover:bg-slate-50 relative overflow-hidden`}>
               ...
               <div className="relative z-10">
                  ...
                  <h5 className="text-4xl font-black uppercase leading-none tracking-tighter mb-4">{f.title}</h5>
                  <p className="text-lg font-bold uppercase leading-tight max-w-[200px]">{f.desc}</p>
               </div>
               
               <motion.button 
                 whileHover={{ x: 5 }}
                 className="flex items-center gap-2 font-black uppercase tracking-widest text-sm mt-12 bg-black text-white px-4 py-2 w-fit border-2 border-black group-hover:shadow-[4px_4px_0px_#FFD600] transition-all"
               >
                  Read Protocol
      ...
      {/* 3. Footer Bar */}
      <div className="border-t-4 border-black p-8 flex flex-col md:flex-row justify-between items-center gap-6 bg-white">
         ...
         <div className="flex gap-4">
            <button className="h-14 px-8 bg-[#FFD600] border-4 border-black text-black font-black uppercase shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all flex items-center gap-3">
               Initialize System
               <Layout size={18} />
            </button>
            <button className="h-14 px-8 bg-black border-4 border-black text-white font-black uppercase shadow-[8px_8px_0px_0px_rgba(255,214,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all">
               Deep Scan
            </button>
         </div>
      </div>
