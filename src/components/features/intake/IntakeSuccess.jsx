...
const IntakeSuccess = ({ formData }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 pt-32 lg:pt-40 bg-transparent relative overflow-hidden">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-20">
           <div className="p-6 bg-muted/30 border-2 border-foreground/10 rounded-3xl text-left">
              <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground block mb-2">Project //</span>
              <p className="font-heading font-black text-lg">{formData.intakeMode === 'new' ? 'New Project' : 'Project Update'}</p>
           </div>
           <div className="p-6 bg-muted/30 border-2 border-foreground/10 rounded-3xl text-left">
              <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground block mb-2">Name //</span>
           ...
           {formData.intakeMode === 'new' && (
             <div className="p-6 bg-muted/30 border-2 border-foreground/10 rounded-3xl text-left col-span-1 md:col-span-2 flex items-center justify-between">
                <div>
                  <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground block mb-2">Design Style //</span>
                  <p className="font-heading font-black text-lg">{selectedThemeName || formData.designPreference || 'Standard'}</p>
                </div>
