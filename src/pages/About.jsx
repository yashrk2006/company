...
const AboutHero = () => {
  ...
  return (
    <section className="px-6 lg:px-24 pt-64 pb-32 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10 text-center">
        <div className="flex flex-col items-center">
          <motion.div 
            ...
            className="w-28 h-28 bg-secondary text-white rounded-3xl border-4 border-foreground flex items-center justify-center mb-16 shadow-pop-lg"
          >
            <Rocket size={56} strokeWidth={3} fill="currentColor" />
          </motion.div>
          
          <h1 className="text-6xl lg:text-[11rem] font-heading text-foreground tracking-tighter leading-[0.8] mb-16 flex flex-col items-center">
            <AnimatedText text="DEFINING THE" from="bottom" />
            <span className="text-primary italic underline decoration-foreground decoration-8 underline-offset-8">
          ...
          <motion.p 
            ...
            className="text-2xl lg:text-4xl text-muted-foreground font-sans max-w-5xl leading-tight font-black tracking-tight"
          >
...
const About = () => {
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="px-6 lg:px-24 py-56 bg-white text-center">
        <div className="max-w-6xl mx-auto p-24 lg:p-32 border-4 border-foreground rounded-[4rem] bg-quaternary shadow-pop-lg relative overflow-hidden group">
           ...
           <div className="relative z-10 flex flex-col items-center">
              <h2 className="text-5xl lg:text-[7rem] font-heading text-foreground mb-16 tracking-tighter leading-none uppercase italic">
                Ready to Build <br /> 
              ...
              <Magnetic strength={0.4}>
                <Link to="/start-project">
                  <motion.button 
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-16 py-8 bg-foreground text-white rounded-full font-heading font-black text-3xl uppercase tracking-widest shadow-pop-lg hover:shadow-none hover:translate-x-2 hover:translate-y-2 transition-all flex items-center gap-6"
                  >
                    Let's Get Started 
                    <ArrowRight size={40} strokeWidth={3} className="group-hover:translate-x-2 transition-transform" />
                  </motion.button>
                </Link>
              </Magnetic>
           </div>
